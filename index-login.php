...
<html lang="en">
  ...
  <body>
      ...
      <nav class="navbar navbar-expand-sm navbar-dark bg-dark h-nav">
        <div class="container-fluid">
          <a class="navbar-brand" href="#">
            <img src="images/user01.png" alt="Avatar Logo" style="width:40px;" class="rounded-pill"> 
          </a>
          ...
          <div class="collapse navbar-collapse" id="mynavbar">
            <ul class="navbar-nav me-auto">
              <!-- <li class="nav-item">
                <a class="nav-link crop-text-nav" href="javascript:void(0)">Member</a>
              </li>
              <li class="nav-item">
                <a class="nav-link crop-text-nav" href="javascript:void(0)">Decode MD5</a>
              </li>
              <li class="nav-item">
                <a class="nav-link crop-text-nav" href="https://www.google.com/" target="blank">Google</a>
              </li>
              <li class="nav-item dropdown dropdown-layout">
    ...
    <ul class="v-ul">
      <li class="v-li"><a class="<?= $page == 'home.php' ? 'active':''; ?>" href="?page=home.php">Home</a></li>
      <li class="v-li"><a class="<?= $page == 'news.php' ? 'active':''; ?>" href="?page=news.php">News</a></li>

      <li class="v-li">
        <a id="li_bootstrapExample" class="<?= $manu == 'bootstrapExample' ? 'active bg-secondary':''?>" data-bs-toggle="collapse" data-bs-target="#bootstrapExample" aria-expanded="false" aria-controls="bootstrapExample">
      ...
      <div class="<?= $manu == 'bootstrapExample' ? '' : 'collapse'?>" id="bootstrapExample">
        <li class="v-li"><a class="<?= $page == 'table.php' ? 'active':''; ?>" href="?manu=bootstrapExample&page=table.php">table</a></li>
        <li class="v-li"><a class="<?= $page == 'carousel.php' ? 'active':''; ?>" href="?manu=bootstrapExample&page=carousel.php">carousel</a></li>
      </div>

      <li class="v-li"><a class="<?= $page == 'abount.php' ? 'active':''; ?>" href="?page=abount.php">About</a></li>
    </ul>     

    <div id="render_screen" class="screen">
      <?php if ($manu == 'bootstrapExample') :?>
        <?php include './page/bootstrapExample/'.$page ?>
      <?php else :?>
