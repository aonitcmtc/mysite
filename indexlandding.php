...
<html lang="en">
    <head>
        ...
        <link href="./mysite/asset/bootstrap.min.css" rel="stylesheet">
        <script src="./mysite/asset/bootstrap.bundle.min.js"></script>

        <script src="./mysite/asset/jquery.slim.min.js"></script>
        <script src="./mysite/asset/popper.min.js"></script>

        <!-- <link href="./mysite/asset/font-awesome.min.css" rel="stylesheet"> -->
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
        <link rel="stylesheet" href="./mysite/asset/bootstrap-icons/bootstrap-icons.css">
    </head>
    <body>
    ...
    <style>
        ...
        .landingpage { 
            ...
            background-image: url("./mysite/public/img-default/langing-cover.png");
